...
void apply_theme() {
    ...
    colors[ImGuiCol_CheckMark] = ImVec4(0.67f, 0.09f, 0.17f, 1.00f);
    colors[ImGuiCol_TabSelectedOverline] = ImVec4(0.67f, 0.09f, 0.17f, 1.00f);
    ...
    colors[ImGuiCol_DockingPreview] = ImVec4(0.56f, 0.08f, 0.15f, 1.00f);
    ...
    colors[ImGuiCol_DragDropTarget] = ImVec4(0.56f, 0.08f, 0.15f, 1.00f);
...
void Gui::init(const Context& ctx, const Swapchain& swapchain) {
    ...
    ImGui_ImplVulkan_InitInfo init_info{
        ...
        .MinImageCount = swapchain.get_image_count(),
...
void Gui::set_image_count(const uint32_t image_count) {
