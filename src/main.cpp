...
void init_vulkan() {
    ...
    while (!Window::should_close()) {
        ...
        vk::WriteDescriptorSetAccelerationStructureKHR write_as_info{
            ...
            .pAccelerationStructures = &*resources->tlas,
        };
        ...
        vk::DescriptorImageInfo descriptor_image_info{
            .imageView = resources->rt_image_view,
        ...
        cmd.bindPipeline(vk::PipelineBindPoint::eRayTracingKHR, resources->rt_pipeline);
        cmd.pushDescriptorSet(vk::PipelineBindPoint::eRayTracingKHR, resources->rt_pipeline_layout, 0, writes);

        cmd.traceRaysKHR(resources->rgen_region,
                         resources->rmiss_region,
                         resources->rchit_region,
                         {},
                         Window::get_width(),
                         Window::get_height(),
                         1);

        layout_transition(cmd, resources->rt_image.get(), vk::ImageLayout::eGeneral, vk::ImageLayout::eTransferSrcOptimal);
        ...
        cmd.copyImage(resources->rt_image.get(),
        ...
        layout_transition(cmd, resources->rt_image.get(), vk::ImageLayout::eTransferSrcOptimal, vk::ImageLayout::eGeneral);
